...
@section('content')
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{url('/Jumuiya-Donation')}}">Jumuiya Donation</a></li>
        </ul>
    </div>

   <jumuiya-donation-component></jumuiya-donation-component>
    {{-- <div class="row">
        ...
        <div class="col-md-7">
            ...
            <div class="tile">
                ...
                <h3 class="tile-title">Jumuiya Payed<span class="fa-pull-right">
                      <form class="" action="{{route('Jumuiya-Donation.index')}}">
                            ...
                            <div class="col-md-9">
                                <select  class="form-control" name="donation_id">
                                    ...
                                    @if(isset($purposes))
                                        ...
                                        @endforeach
                                    @endif@include('includes.Response_Message')
                ...
                {{-- @if(isset($michango))
                    <table  class="table  table-responsive ">
                        ...
                        @foreach($michango->jumuiya as $key=>$don )
                            <tr>
                                <td>{{$count++}}</td>
        ...
        <div class="col-md-5">
            ...
            <div class="tile">
                <h3 class="tile-title">Jumuiya Payment</h3>

                <div class="tile-body">
                    <form method="post" action="{{url('/Jumuiya-search')}}" role="search">
                        {{csrf_field()}}
                        <div class="form-group row" >
                    ...
                    <form class="form-horizontal" method="POST" action="{{route('Jumuiya-Donation.store')}}" id="section-form"  enctype="multipart/form-data">
                        {{ csrf_field() }}
                                ...
                                <select  class="form-control" name="member_id">
                                    ...
                                    @if(isset($members))
                                        @foreach($members as $member )
                                            <option style="color: black" value="{{$member->id}}">{{$member->name}} &nbsp; <span class="text-muted">&nbsp;Kigango cha</span> &nbsp;<span style="color: yellow">{{$member->mtaa->kigango->name}}</span></option>
                                        @endforeach
                                    @endif
                                    --}}
                                {{-- </select>
