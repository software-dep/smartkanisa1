    ...
    <div class="tile">
       ...
       <div class='row'>
                  <div class='col-md-8 col-sm-8'><h4 style="margin-bottom:0px">Tarehe Ya Kumbukumbu</h4></div>
                    <div class="col-md-4 col-sm-4"><span class='pull-right'><a class="nav-link " title="click to add" data-toggle="modal" data-target="#add"><button class="btn btn-success" ><span class="fa fa-plus " ></span></button></a></meta>
                    </div>
        </div>
