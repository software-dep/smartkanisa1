...
@section('content')
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{url('/Family-Donation')}}">Family Donation</a></li>
        </ul>
    </div>
   
        <family-donation-component></family-donation-component>

        {{-- <div class="col-md-7">

            <div class="tile">

                <h3 class="tile-title">Family Payed<span class="fa-pull-right">
                      <form class="" action="{{route('Family-Donation.index')}}">
                ...
                {{-- @if(isset($michango))
                    <table  class="table  table-responsive ">
                        ...
                        @foreach($michango->families as $key=>$don )
                            <tr>
                                <td>{{$count++}}</td>
        ...
        <div class="col-md-5">
            ...
            <div class="tile">
                <h3 class="tile-title">Family Payment</h3>

                <div class="tile-body">
                    <form method="post" action="{{url('/Family-search')}}" role="search">
                        {{csrf_field()}}
                        <div class="form-group row" >
                    ...
                    <form class="form-horizontal" method="POST" action="{{route('Family-Donation.store')}}" id="section-form"  enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select  class="form-control" name="member_id">
                                    <option >--Choose Family--</option>
                                    @if(isset($members))
                                        @foreach($members as $member )
                                            <option style="color: black" value="{{$member->id}}">{{$member->name}} &nbsp; &nbsp;Jumuiya&nbsp;<span style="color: yellow">{{$member->jumuiya->name}}</span></option>
                                        @endforeach
                                    @endif
                                    --}}
                                {{-- </select>
