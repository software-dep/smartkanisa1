    ...
    <div class="row">
        ...
        <div class="col-md-10">
                ...
                <div class='row tile-title'>
                   <h3 class="col-sm-10">Communities Paid</h3>
                    ...
                    <div v-else>
                        ...
                        <tbody>
                            ...
                            <tr v-for="(rec, index) in records" :key="index" >
                                ...
                                <td class="text-capitalize">{{rec.mtaa.name}}</td>
                                <td class="text-capitalize">{{rec.mtaa.kigango.name}}</td>
              ...
              configFractionSeparator, configSymbolPosition, configSymbolSpacing)}}</td>
                                ...
                                <td>
                                    ...
                                    <a  @click="DeleteData(rec.id)" class="text-danger bs-popover-auto" title="click to delete"> <span class="fa fa-trash "></span> </a>
                          ...
                          <div class="modal-body ">
                              <div class="form-group row">
                                  ...
                                  <div class="col-md-8 row no-gutters align-items-center">
                                       ...
                                       <div class="col">
                                        <input class="form-control form-control form-control-borderless" type="text" placeholder="Please write community name here" v-on:keyup="search_function_member()" v-model="search">
                                    </div>
                                  </div>
                              </div>
                                 ...
                                 <div class="form-group row">
                                  ...
                                  <div class="col-md-8">
                                          <select  class="form-control"  v-model="jumuiya_id"    id="description" >
                                    <option v-for="(m, index) in member" :key="index" v-bind:value="m.id">jumuiya - {{m.name}}: mtaa - {{m.mtaa.name}}: kigango - {{m.mtaa.kigango.name}}</option>
       ...
       methods:{
            ...
            storeData(){
                // alert(this.amount+ " "+this.donation+" "+this.member_id)
                   this.loading=true
                    axios.post('https://bugandoparish.org/api/jumuiya_donation',{
           ...
           select(){
                     ...
                     this.loading=true
                  axios.post('https://bugandoparish.org/api/jumuiyaList',{
                      id:this.donation
                  })
                   .then(response => {
                        this.loading=false            
                        this.record=response.data.data;
                        this.records=response.data.data.jumuiya;
                ...
                get_michango(){
                    	axios.get('https://bugandoparish.org/api/get_selection_jumuiya')
                             .then(response => { 
                    ...
                    axios.post('https://bugandoparish.org/api/search_jumuiya',{
                          name:this.search
                    }).then(
                        response =>{
                             if(response.data.status==200){
                      ...
                      this.$swal.fire({
                               ...
                               confirmButtonText: 'Yes, delete it!'
                                     ...
                                     if (result.value) {
                                              ...
                                              axios.delete('https://bugandoparish.org/api/jumuiya_donation/'+id).then(
                                                 response=>{
                                                             if(response.data.status==200)
                                                                       {
                                                                         this.select()
