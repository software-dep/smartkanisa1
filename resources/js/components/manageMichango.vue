...
import { isMobile } from 'mobile-device-detect';
    export default {
       ...
       methods:{
            ...
            getResults(page = 1) {
                 this.loading=true
			axios.get('http://localhost:8000/api/donations?page=' + page)
				.then(response => {
                     this.loading=false
            ...
            storeData(){
                ...
                //    this.loading=true
                    axios.post('http://localhost:8000/api/donations',{
                        name:this.name,
            ...
            get_alldata(){
                ...
                axios.delete('http://localhost:8000/api/donations/'+this.id).then(
                    response=>{
                        if(response.data.status==200){
                     ...
                     axios.get('http://localhost:8000/api/donations/'+id).then(
                    response=>{
                        if(response.data.status==200){
                ...
                //    console.log(data);
                      ...
                      axios.put('http://localhost:8000/api/update_donations',data).then(
                    response=>{
                        if(response.data.status==200){
                             this.get_alldata();
                             this.$swal("Good job!", response.data.message, "success");
