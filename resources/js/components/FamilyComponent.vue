    ...
    export default {
       ...
       methods:{
             check(){
                        ...
                        axios.post('https://bugandoparish.org/api/get_mitaa',{
                           data:this.selected
      ...
      this.families.data.sort(fn);
                 ...
                 check_j(){
                        ...
                        axios.post('https://bugandoparish.org/api/get_jumuiya',{
                  ...
                  this.loading=true
                 axios.post('https://bugandoparish.org/api/arrange',{
            ...
            // pagination
            getResults(page = 1) {
			axios.get('https://bugandoparish.org/api/family_retreive?page=' + page)
				.then(response => {
            ...
            storeData(){
                  this.loading=true
                    axios.post('https://bugandoparish.org/api/family_insert',{
                        name:this.name,
            ...
            search_family(){
                this.loading=true
                    axios.post('https://bugandoparish.org/api/family_search',{
                    name:this.search  
...
// 
            ...
            get_alldata(){
                  this.loading=true
                  axios.get('https://bugandoparish.org/api/family_retreive')
                   .then(response => {
                 ...
                 this.loading=true
                axios.delete('https://bugandoparish.org/api/family_delete/'+this.id).then(
                    response=>{
                        if(response.data.status==200){
                              this.loading=false
                      ...
                      this.loading=true
                     axios.get('https://bugandoparish.org/api/family_show/'+id).then(
                    response=>{
                        if(response.data.status==200){
                              this.loading=false
                ...
                updateData(id,jumuiya,family){
                   var data ={
                     ...
                     this.loading=true
                      ...
                      axios.put('https://bugandoparish.org/api/family_update',data).then(
                       response=>{
                        if(response.data.status==200){
                              this.loading=false
                             this.$swal("Good job!", response.data.message, "success");
