    ...
    <div class="row">
        ...
        <div class=" col-md-12">
               ...
               <div class="table-responsive-sm table-responsive-md" >
                    <table  class="table table-hover table-bordered " ref="table">
...
import columnSortable from 'vue-column-sortable'
    export default {
       ...
       methods:{
            ...
            // pagination
            getResults(page = 1) {
			axios.get('https://bugandoparish.org/api/members?page=' + page)
				.then(response => {
      ...
      this.members.data.sort(fn);
            ...
            get_alldata(){
              ...
              search_function(){   
                  this.loading=true 
                      axios.post('https://bugandoparish.org/api/family_member_search',{
                        name:this.search
                      }).then(response=>{
            ...
            search_family1(){
                      ...
                      if(this.selected == 1){
                   axios.post('https://bugandoparish.org/api/family_member_search1',{
                     data:this.query
                   }).then(response =>{
                       if(response.data.status == 200){
                             this.search_data=response.data.data;
                      ...
                      axios.post('https://bugandoparish.org/api/members_search_data',{
                        data:this.query
                      }).then(response=>{
                        if(response.data.status == 200){
       ...
       this.loading=true
                ...
                get_family_id(name){
                  if(this.selected==1){
                       axios.post('https://bugandoparish.org/api/search_family_members',{
                          id:name.id
                  })
                  .then(response=>{
                   if(response.data.status==200){
